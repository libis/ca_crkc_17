 ...
 */
	...
	if($this->request->config->get('summary_header_enabled')) {
        ...
        $vs_footer .= "<td class='footerText'  style='font-family: \"Sans Light\"; font-size: 12px; text-align: center;'>CRKC | Abdij van Park 7 | 3001 Heverlee | 016 406073 | info@crkc.be</td>";
